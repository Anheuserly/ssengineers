      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <h1 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
            Fire Safety Services in Faridabad
          </h1>
          <p className="mt-3 max-w-2xl mx-auto text-gray-500">
            Keep your home and workplace safe in <strong>Faridabad</strong> with AMCMEP’s fire detection, extinguishers, and AMC maintenance services.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-white rounded-lg shadow-md p-8 inline-block">
            <h2 className="text-2xl font-bold text-gray-900">
              Need Fire Safety Solutions in Faridabad?
            </h2>
            <p className="mt-2 text-gray-600">
              Contact our Faridabad team today for a free consultation and site survey.
            </p>
            <div className="mt-6">
              <Link
                href="/contact"
