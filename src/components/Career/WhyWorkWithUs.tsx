  ...
  const reasons = [
    {
      ...
      description: "We invest in our employees' development with training programs and clear career progression paths.",
      icon: (
    ...
    },
    {
      ...
      description: "Work with cutting-edge MEP technologies and contribute to innovative solutions in the industry.",
      icon: (
        <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "We value your personal time and offer flexible work arrangements to maintain a healthy balance.",
      icon: (
        <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            At SHREE GANESHE ENTERPRISES, we believe our employees are our greatest asset. 
