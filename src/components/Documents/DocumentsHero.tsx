  ...
  return (
    <section className="relative h-96 w-full flex items-center justify-center overflow-hidden bg-gray-900">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: "url('https://images.unsplash.com/photo-1586281380117-5a60ae2050cc?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1770&q=80')",
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
        ...
        <p className="text-xl md:text-2xl font-light mb-10 max-w-2xl mx-auto leading-relaxed">
          Access our official certificates, registrations, and compliance documents
        </p>
